...
function startConversation(){
    ...
    const questions = [
        ...
        { text: "Book a consultation", emoji: "📅", reply: `Great! You can book a free 30-minute consultation directly here:<br><br><a href="https://calendly.com/aleksicboris94/30min" target="_blank" style="display:inline-block;margin-top:6px;padding:10px 18px;border-radius:50px;border:1.5px solid #c4a8ff;background:#fff;color:#5a2db8;font-weight:600;font-size:13px;text-decoration:none;" onmouseover="this.style.background='#f0e8ff';this.style.borderColor='#854fff'" onmouseout="this.style.background='#fff';this.style.borderColor='#c4a8ff'">📅 Book a free consultation →</a>` }
    ];
